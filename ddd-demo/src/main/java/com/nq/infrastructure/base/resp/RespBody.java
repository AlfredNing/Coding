package com.nq.infrastructure.base.resp;
...
public class RespBody<T> {
    ...
    public static RespBody<ErrorBody> error(
        ResultCode resultCode, ErrorBody errorBody) {
        return build(resultCode.getCode(), resultCode.getMessage(), errorBody);
    }

    public static RespBody<ErrorBody> error(
        ResultCode resultCode, String message, ErrorBody errorBody) {
