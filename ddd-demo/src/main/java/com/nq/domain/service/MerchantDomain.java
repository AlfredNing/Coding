package com.nq.domain.service;

import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.nq.application.service.MerchantService;
import com.nq.domain.entity.Merchant;
import com.nq.domain.entity.Store;
import com.nq.infrastructure.repository.impl.MerchantRepository;
import com.nq.infrastructure.repository.impl.MerchantStoreRelRepository;
import com.nq.infrastructure.repository.impl.StoreRepository;
import com.nq.domain.vo.MerchantStoreRel;
import com.nq.domain.vo.Rate;
import com.nq.infrastructure.base.error.BusinessException;
import com.nq.infrastructure.base.resp.RespBody;
import com.nq.interfaces.dto.AddStoreDTO;
import com.nq.interfaces.dto.MerchantComeInDTO;
import com.nq.interfaces.dto.StoreDTO;
...
/**
 * @author EalenXie create on 2021/3/1 15:59 商户领域对象 完成 application层 委托的功能  (与领域服务不是同一概念 本例中没有领域服务案例)
 */
@Service
